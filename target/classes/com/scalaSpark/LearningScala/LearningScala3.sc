//object LearningScala3 {
  ...
  def upperFunc(str: String) : String = {
    str.toUpperCase()
  }

  def upperFuncTest(x: String, f: String => String) : String  = {
    f(x)
  }
  val result1 = upperFuncTest("rishabh",upperFunc)
  println(result1)

  upperFuncTest("name", x => x.toUpperCase())
