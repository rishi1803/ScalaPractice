...
/**
  * Created by Rishabh on 03,May,2020
  */
...
object DegreesOfSeparation {
  ...
  val targetCharacterID = 5 //ADAM 3,031 (who?)
  ...
  def createStartingRdd(sc:SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("C:\\Users\\SUNNY\\Desktop\\SCALA\\SparkScala\\Marvel-graph.txt")
